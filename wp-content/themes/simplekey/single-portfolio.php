    ...
    <section class="page-area" id="single-content">
       <div class="wrapper">
          <div id="breadcrumbs">
           ...
           <?php elseif($portfolio_layout=="Grid View" || $portfolio_layout=="Grid"):
		      if($portfolio_col==4){
			     $layout=" columns4";
           ...
           <?php 
			  ...
			  if($portfolio_video<>''){
		    ?>
            <div id="portfolio-media" class="video">
           ...
           <?php 
			 ...
			 if($portfolio_audio<>''){
		   ?>
            <div id="portfolio-media" class="audio">
		...
		?>
           ...
           <article class="post">
               ...
               <div class="entry">
                  ...
                  <?php wp_link_pages('<div class="sk_pagenavi">', '</div>', 'number');?> 
               </div>
