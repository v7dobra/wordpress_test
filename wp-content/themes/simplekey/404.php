       ...
       <div class="wrapper">
           ...
           <div class="entry">
             ...
             <div class="column one_half">
               <a href="<?php echo home_url();?>" class="sk_small_btn" style="float:right;margin:auto;background:#55ac4a;color:#fff;"><?php esc_html_e('Return to the Homepage','SimpleKey');?></a>     
             </div>
             <div class="column one_half last">
                <a href="mailto:<?php echo $SK['email'];?>" class="sk_small_btn" style="float:none;margin:auto;background:#F90;color:#fff;"><?php esc_html_e('Report to webmaster','SimpleKey');?></a>   
             </div>
           </div>
       </div>
    </section>
