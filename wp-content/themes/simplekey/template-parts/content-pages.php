<?php
  ...
  $pageSectionSetting=get_post_meta($post->ID, "page_section_setting_value", true);
...
?>
    <section id="<?php echo $post->post_name;?>" class="page-area <?php echo $bgClass.' '.$parallax;?>"<?php echo $style;?>>
       <div class="wrapper <?php echo esc_attr($pageSectionSetting);?>"<?php if($fullEmbed<>''):?> style="width:100%"<?php endif;?>>
         <?php if($hideTitle!='Yes'):?>
           <header class="title<?php echo sk_css_animate(' wpb_animate_when_almost_visible wpb_bottom-to-top');?>">
         ...
         <?php endif;?>
         <?php if($fullEmbed<>''):?>
           <div class="full-embed"><?php echo sk_shortcode($fullEmbed);?></div>
         <?php else:?>
