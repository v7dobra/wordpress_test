<?php global $SK;?>
<?php if(!isset($SK['hide_foot']) || $SK['hide_foot']==1):?>
<footer id="footer">
 <div class="wrapper">
      <div class="footer-l">
        <?php echo $SK['copyright'];?>
        <?php if($SK['theme_credit']==1):?> / Designed by <a href="http://www.themevan.com" target="_blank" title="Premium WordPress Themes">ThemeVan</a><?php endif;?>
      </div>
...
<?php if(!isset($SK['hide_backtoTop']) || $SK['hide_backtoTop']==1):?>
