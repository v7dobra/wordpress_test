 ...
 */
function sk_show_if_front_page( $cmb ) {
 ...
 * @return bool                     True if metabox should show
 */
function sk_hide_if_no_cats( $field ) {
 ...
 * @param  CMB2_Field object $field      Field object
 */
function sk_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'sk_register_page_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function sk_register_page_metabox() {
	...
	/*$cmb_simplekey_page_setting->add_field( array(
		...
		'id'               => 'page_menu'.$suffix,
		'type'             => 'select',
		'options_cb'        => 'Get_All_Wordpress_Menus'
	) );*/
	...
	$cmb_simplekey_page_style->add_field( array(
		'name'             => esc_html__( 'Section Setting', 'SimpleKey' ),
		'desc'             => esc_html__( 'Set the width of section wrapper. ', 'SimpleKey' ),
		'id'               => 'page_section_setting'.$suffix,
		'type'             => 'select',
		'options'		   => array(''=>'Default','stretch'=>'Stretch','stretch-no-padding'=>'Stretch(no padding)'),
		'default'		   => '0'
	) );
	...
	$cmb_simplekey_portfolios->add_field( array(
		...
		'type'             => 'textarea_code',
		'desc'			   =>'<a href="'.get_template_directory_uri().'/inc/assets/images/help/video.jpg" target="_blank">'.esc_html__('How to get Youtube/Vimeo embed code?','SimpleKey').'</a>'
	) );
	...
	$cmb_simplekey_portfolios->add_field( array(
		...
		'type'             => 'textarea_code',
		'desc'			   =>'<a href="'.get_template_directory_uri().'/inc/assets/images/help/sc.jpg" target="_blank">'.esc_html__('How to get SoundCloud embed code?','SimpleKey').'</a>'
	) );
