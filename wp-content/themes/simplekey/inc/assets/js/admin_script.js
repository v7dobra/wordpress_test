...
jQuery(document).ready(function(){
	...
	jQuery('.cmb2-id-portfolio-video-value').add('.cmb2-id-portfolio-audio-value').add('#be_gallery_metabox').add('.cmb2-id-portfolio-col-value').hide();
	var portfolio_type=jQuery('select[name="portfolio_type_value"]');
	function portfolio_types(){
	    if(portfolio_type.val()=='Image'){
             jQuery('.cmb2-id-portfolio-video-value,.cmb2-id-portfolio-audio-value').hide();
             jQuery('#be_gallery_metabox,.cmb2-id-portfolio-layout-value').fadeIn();
		}else if(portfolio_type.val()=='Video'){
             jQuery('.cmb2-id-portfolio-video-value').show();
			 jQuery('.cmb2-id-portfolio-audio-value,.cmb2-id-portfolio-layout-value').hide();
			 jQuery('#be_gallery_metabox').hide();
		}else if(portfolio_type.val()=='Audio'){
		     jQuery('.cmb2-id-portfolio-audio-value').show();
			 jQuery('.cmb2-id-portfolio-video-value,.cmb2-id-portfolio-layout-value').hide();
			 jQuery('#be_gallery_metabox').hide();
		}
	}portfolio_types();
