...
function sk_portfolios_filter($inverse=0,$exclude='',$include_slug='',$echo=true){
	...
	$return_html='';
	if($count > 0){
     $return_html.='<nav id="filter" data-option-key="filter" class="tax'.$class.sk_css_animate(' wpb_animate_when_almost_visible wpb_bottom-to-top').'">
		  <ul>
