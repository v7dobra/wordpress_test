<form class="sh-wrap">
	...
	<select id="sh_list" name="sh_list" class="widefat sh-list" style="width: 50%;">
        ...
        <option value="sk_button">Button</option>
	...
	<div class="center" style="display: none;">
        ...
        <br><span class="sk_desc">If you want to center a container, please enter the container's total width, e.g. 500px or 40%</span>
	</div>
	<!-- center column -->
	...
	<div class="separator" style="display: none;">
		...
		<br><span class="sk_desc">Enter your color code, e.g. #000000</span>
		<br>
	</div>
	<!-- end separator -->
...
<ul>
  ...
  <li>You list content here</li>
		...
		<br><span class="sk_desc">You must organize the list content as "ul li"</span>
	</div>
	<!-- end list -->
	...
	<div class="headline" style="display: none;">
		...
		<br><span class="sk_desc">Distance from next section, e.g. 30px</span>
	</div>
	<!-- end headline -->
	...
	<!-- Button -->
	<div class="sk_button" style="display: none;">
		...
		<br><span class="sk_desc">Don't forget add "http://" in front of the link.</span>
        <br>
		<br>
		...
		<br><span class="sk_desc">e.g. #000000</span>
        <br>
		<br>
		...
		<br><span class="sk_desc">e.g. #ffffff</span>
        <br>
        <br>
		...
		<br><span class="sk_desc">e.g. #333333</span>
	...
	<div class="feature_item" style="display: none;">
		...
		<br><span class="sk_desc">You should upload the image via "Media" first, then paste the image URL here.</span>
        <br>
        <br>
		...
		<br><span class="sk_desc">Don't forget http:// in front of the link, also, if you don't wanna add the link, just leave it empty.</span>
        <br>
		<br>
	...
	<div class="pricing_table" style="display: none;">
        ...
        <br><span class="sk_desc">E.g. "$ , ￥"</span>
		<br>
        <br>
        ...
        <br><span class="sk_desc">E.g. "/Year , /mo, or you can leave it empty"</span>
		<br>
        <br>
	...
	<div class="slide" style="display: none;">
		...
		<br><span class="sk_desc">Just copy the Youtube Video page URL</span>
        <br>
        <br>
        <label for="slide_vimeo">Vimeo URL</label>
		<br>
		<input type="text" id="slide_vimeo" name="slide_vimeo" value="" class="widefat" style="width: 30%;" />
		<br><span class="sk_desc">Just copy the Vimeo Video page URL</span>
        <br>
        <br>
		...
		<br><span class="sk_desc">Default height is 450px</span>
	</div>
	<!-- end feature_item -->
	...
	<div class="member" style="display: none;">
        ...
        <br><span class="sk_desc">Don't forget http:// in front of the URL</span>
        <br>
        <br>
	...
	<div class="blog">
		...
		<br><span class="sk_desc">If you leave it empty, it will display 5 posts</span>
        <br>
           <br>
		...
		<br><span class="sk_desc">Please add category slug, separate multiple category slugs with commas. If you leave it empty, it will show the posts from all categories</span>
        <br>
	...
	<div class="portfolios" style="display: none;">
		...
		<br><span class="sk_desc">If you leave it empty, it will display 9 portfolios</span>
        <br>
        <br />
	...
	<div class="skill" style="display: none;">
        ...
        <br><span class="sk_desc">Use this text to instead of the percent number, but if you hide percent above, the text will be also hidden.</span>
        <br>
        <br>
